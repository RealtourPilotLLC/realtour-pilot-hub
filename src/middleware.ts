...
// require in order to issue production credentials, and reviewers must be able
// to open them without signing in.
...
// the gate. Opening the prefix would bypass middleware auth
