...
export const PROVIDERS: ProviderDef[] = [
  {
    ...
    capabilities: [
      "Auto-import orders into the pipeline",
      "Sync clients, listings & products",
      "Pull appointments & scheduling",
      "Real-time webhooks (order fulfilled, media delivered, invoice paid)",
    ],
    ready: true,
  },
  {
