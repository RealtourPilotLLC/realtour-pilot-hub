...
//
// A row sitting in the Review Room, or approved and waiting on delivery, is on
// the office — not on Kim. A row with no footage in yet is nobody's edit. The
// editor's own header says "4 to edit · 1 in review · 2 waiting on footage" off
// these two lists, and anything else that counts an editor's pile has to read
// the same ones or the hub tells two people different numbers about the same
// person. They were written inline in the page; they live here so there is one
// copy to be wrong.
// ---------------------------------------------------------------------------
